...
bool  g_ligne::  modifier_ligne(int n,QString e)
{
    ...
    QString res1=QString::number(n);
     query.prepare("Update ligne set  destination= :e where  ID_LIGNE= :n");
...
{
    QSqlQueryModel *model=new QSqlQueryModel();
    model->setQuery("select * from LIGNE order by destination asc ");
    model->setHeaderData(0, Qt::Horizontal, QObject::tr("ID_LIGNE"));
    model->setHeaderData(1, Qt::Horizontal, QObject::tr("nom"));
    model->setHeaderData(2, Qt::Horizontal, QObject::tr("source "));
    model->setHeaderData(3, Qt::Horizontal, QObject::tr(" destination"));
...
QSqlQueryModel * g_ligne::afficher_tri_ID_ligne()
{
    QSqlQueryModel *model=new QSqlQueryModel();
    model->setQuery("select * from LIGNE order by ID_LIGNE asc ");
    model->setHeaderData(0, Qt::Horizontal, QObject::tr("ID_LIGNE"));
    model->setHeaderData(1, Qt::Horizontal, QObject::tr("nom"));
    model->setHeaderData(2, Qt::Horizontal, QObject::tr("source "));
    model->setHeaderData(3, Qt::Horizontal, QObject::tr(" destination"));
...
QSqlQueryModel * g_ligne::afficher_source()
{
    QSqlQueryModel *model=new QSqlQueryModel();
    model->setQuery("select * from LIGNE order by source asc ");
    model->setHeaderData(0, Qt::Horizontal, QObject::tr("ID_LIGNE"));
    model->setHeaderData(1, Qt::Horizontal, QObject::tr("nom"));
    model->setHeaderData(2, Qt::Horizontal, QObject::tr("source "));
    model->setHeaderData(3, Qt::Horizontal, QObject::tr(" destination"));
